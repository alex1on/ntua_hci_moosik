...
class Default2Page extends StatefulWidget {

  late User user;

  Default2Page({Key? key, required this.user}) : super(key: key);

  @override
  State<Default2Page> createState() => _Default2PageState();
}

class _Default2PageState extends State<Default2Page> {
