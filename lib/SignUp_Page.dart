...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void MakeDefaultPlaylists(int userID) async {
    ...
    _defaultPlaylists
        .add(Playlist(id: Happy_id, title: 'Happy', userID: userID));
    _defaultPlaylists.add(Playlist(id: Sad_id, title: 'Sad', userID: userID));
    _defaultPlaylists
        .add(Playlist(id: Excited_id, title: 'Excited', userID: userID));
    _defaultPlaylists
        .add(Playlist(id: Angry_id, title: 'Angry', userID: userID));
  }
